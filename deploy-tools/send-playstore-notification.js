...
async function sendPlayStoreNotification() {
  try {
    await ssh.connect({
      host: '65.20.77.112',
      username: 'root',
...
const iconUrl = 'https://play-lh.googleusercontent.com/eVvxzc9zxEIWRCnEkJjRsCdVK5oEWINHrmCz8uNBrSi_gLwHK2J94-gqM3LMhnyg7ogq_iV52z3zzzuselZx5Zc=s0-br30';

const message = {
  topic: 'workers',
  notification: {
    title: '🎉 New Task Available! Earn ₹24.50',
    body: 'Instamart: Android App Install & Open task is now available. Complete now to earn instant cash!',
    imageUrl: iconUrl,
  },
  data: {
    type: 'NEW_TASK',
    click_action: 'FLUTTER_NOTIFICATION_CLICK',
    taskId: '2a177233-f348-41a6-be14-a8a08dc7c706',
    orderId: '18d4fff8-d2e7-479b-9e54-710f60e28017',
    reward: '24.50',
    serviceCode: 'APP_INSTALL',
    ...
    appIcon: iconUrl,
    appName: 'Instamart',
    targetUrl: 'https://play.google.com/store/apps/details?id=in.swiggy.android.instamart',
  },
  android: {
    priority: 'high',
    notification: {
...
admin.messaging().send(message)
  .then(resp => {
    console.log('✅ Instamart Play Store Task Notification broadcasted! Message ID:', resp);
    process.exit(0);
  })
  .catch(err => {
