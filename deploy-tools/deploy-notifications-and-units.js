...
async function deploy() {
  ...
  const filesToUpload = [
    ...
    {
      local: path.join(basePath, 'apps/api/controllers/worker/notification.controller.ts'),
      remote: '/opt/task-engine/apps/api/controllers/worker/notification.controller.ts',
    },
  ];
