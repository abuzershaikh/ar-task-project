...
export class TaskStateMachine {
    private static readonly transitions: Map<TaskStatus, TaskStatus[]> = new Map([
        ...
        [TaskStatus.IN_PROGRESS, [TaskStatus.SUBMITTED, TaskStatus.UNDER_REVIEW, TaskStatus.ACTIVE, TaskStatus.EXPIRED, TaskStatus.CANCELLED]],
        [TaskStatus.SUBMITTED, [TaskStatus.UNDER_REVIEW, TaskStatus.APPROVED, TaskStatus.REJECTED]],
        [TaskStatus.UNDER_REVIEW, [TaskStatus.APPROVED, TaskStatus.REJECTED, TaskStatus.IN_PROGRESS]],
        [TaskStatus.REJECTED, [TaskStatus.ACTIVE, TaskStatus.IN_PROGRESS, TaskStatus.FAILED]],
        [TaskStatus.APPROVED, []],
