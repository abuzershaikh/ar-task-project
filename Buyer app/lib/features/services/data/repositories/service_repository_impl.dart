  ...
  List<ServiceModel> _getFallbackServices() {
    return [
      ...
      ServiceModel(
        ...
        name: 'Instagram Engagement Combo (Like + Follow + Comment)',
        description: 'Boost profile authority and post reach: Real users follow profile, like post/reel, and leave topic-relevant comments.',
        category: 'Instagram',
        serviceType: 'combo',
        isActive: true,
        aiGeneratorEnabled: true,
        aiGeneratorConfig: const {
          ...
          'generatorType': 'instagram_comment',
          'enabled': true,
          'actions': {'like': true, 'follow': true, 'comment': true},
        },
        currentVersion: 1,
        linkFieldLabel: 'Instagram Post / Reel or Profile URL',
        linkFieldPlaceholder: 'https://www.instagram.com/p/... or /reel/... or /your_username',
        pricing: const PricingConfig(
          modelType: PricingModelType.countBased,
          buyerPrice: 2.50,
          unitPrice: 2.50,
        ...
        elements: const [
          TemplateElement(
            ...
            label: 'Instagram Engagement Combo (Like + Follow + Comment)',
            category: ElementCategory.display,
            type: ElementType.heading,
            visibility: VisibilityContext.both,
            editability: EditabilityMode.adminFixed,
