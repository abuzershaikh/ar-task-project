...
class CrashlyticsService {
  ...
  static Future<void> initialize() async {
    try {
      ...
      // In debug mode, Crashlytics collection can remain enabled for testing or disabled
      await _crashlytics.setCrashlyticsCollectionEnabled(true);
      debugPrint('✅ [CRASHLYTICS] Buyer App Crashlytics initialized successfully');
    } catch (e) {
  ...
  static Future<void> recordApiError({
    ...
    try {
      ...
      debugPrint('🚨 [CRASHLYTICS API REPORT] Logged: $reason');
    } catch (_) {}
  }
