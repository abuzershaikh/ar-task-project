                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        _buildMetricItem('Total Services', '${allServices.length}', primaryBlue, Icons.apps_rounded),
                        Container(height: 28, width: 1, color: borderSubtle),
                        _buildMetricItem('Active', '$activeCount', const Color(0xFF10B981), Icons.check_circle_rounded),
                        Container(height: 28, width: 1, color: borderSubtle),
                        _buildMetricItem('Turnaround', '24-72h', const Color(0xFF0EA5E9), Icons.timer_outlined),
                        Container(height: 28, width: 1, color: borderSubtle),
                        _buildMetricItem('Engine', 'Live', const Color(0xFF8B5CF6), Icons.bolt_rounded),
                      ],
                    ),
                  ),
