...
class _ServiceBuilderScreenState extends State<ServiceBuilderScreen>
  ...
  final List<Map<String, dynamic>> _presetTemplates = [
    ...
    },
    {
      ...
      'desc': 'All-in-one engagement: Like video + Subscribe to Channel + Post unique comment',
      'buyerPrice': 8.0,
      'margin': 2.5,
      'workerReward': 5.5,
    ...
    },
    {
      ...
      'name': 'Instagram Growth Combo (Follow + Like + Comment)',
      'desc': 'All-in-one viral package: Follow profile + Like post + leave comment',
      'buyerPrice': 4.50,
      'margin': 0.90,
      'workerReward': 3.60,
      'linkLabel': 'Instagram Post / Profile URL',
      'linkPlaceholder': 'https://instagram.com/profile',
      'needText': true,
      'textLabel': 'Niche / Comment Guidance',
      'textPlaceholder': 'e.g. Fitness tips, lifestyle aesthetic',
      'watchtime': 0,
      'aiEnabled': true,
    },
    {
